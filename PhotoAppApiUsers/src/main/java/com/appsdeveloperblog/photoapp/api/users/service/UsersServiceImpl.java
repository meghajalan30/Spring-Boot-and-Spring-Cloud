...
public class UsersServiceImpl implements UsersService {
    ...
    @Autowired
    public UsersServiceImpl(UsersRepository usersRepository,BCryptPasswordEncoder bCryptPasswordEncoder,AlbumServiceClient albumServiceClient,Environment environment)
    {
    ...
    //when authenticating the user login details, spring will look for this method
    @Override
